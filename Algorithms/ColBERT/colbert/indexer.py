...
class Indexer:
    ...
    def index(self, name, collection, query_maxlen, overwrite=False):
        ...
        self.configure(nranks=4, bsize=384, partitions=None, doc_maxlen=512, query_maxlen=query_maxlen) # nranks=1, bsize=64, doc_maxlen=220
